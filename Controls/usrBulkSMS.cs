...
namespace Astrodon {
    ...
    public partial class usrBulkSMS : UserControl {
        ...
        private void PostPastel(String reference, int entries, out String pastelString) {
            ...
            String pastelReturn1 = Controller.pastel.PostBatch(DateTime.Now, buildPeriod, "CENTRE17", selectedBuilding.DataPath, 5, selectedBuilding.Journal, selectedBuilding.Centrec_Account, "9250000", "1115000", "1115000", "SMS", reference, amt, selectedBuilding.Centrec_Building, "", out pastelString);
        }
