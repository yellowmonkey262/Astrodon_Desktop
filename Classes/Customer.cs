    ...
    public class Customer {
        ...
        public Customer(String CustomerString) {
            ...
            try {
                ...
                try { lastCrDate = Controller.pastel.convertDate(customerBits[66]).ToString("yyyy/MM/dd"); } catch { }
                ...
                try { createDate = Controller.pastel.convertDate(customerBits[127]).ToString("yyyy/MM/dd"); } catch { }
            } catch (Exception ex) {
        ...
        public String GetCustomer() {
            ...
            try {
                ...
                MessageBox.Show("Del Address" + ex.Message);
                customerString += "||||";
            }
            ...
            try {
                ...
                MessageBox.Show("Email" + ex.Message);
            }
        ...
        public void SetNotes(List<String> note) {
            ...
            foreach (String nLine in note) {
                ...
                if (nBit.Length >= 9) {
                    ...
                    myNote.entryDate = Controller.pastel.convertDate(nBit[4]);
                    myNote.actionDate = Controller.pastel.convertDate(nBit[5]);
