...
namespace Astrodon {
    ...
    public partial class frmClearance : Form {
        ...
        private void DeleteRow(bool journal) {
            ...
            if (Environment.MachineName != "STEPHEN-PC" && journal) {
                ...
                if (building != null) {
                    ...
                    String pastelReturn, pastelString;
                    if (clr.extClearance) {
                        pastelReturn = Controller.pastel.PostReverseBatch(trnDate, building.Period, values.centrec, building.DataPath, 5, building.Journal, building.Centrec_Account, clr.customerCode, building.Centrec_Building, building.Centrec_Building, docType, docType, "-390.00", "5500/000", "", out pastelString);
                        Controller.pastel.PostBusGBatch(trnDate, 5, "5500000", clr.customerCode, docType, docType, "-390.00");
                    }
                    pastelReturn = Controller.pastel.PostReverseBatch(trnDate, building.Period, values.centrec, building.DataPath, 5, building.Journal, building.Centrec_Account, clr.customerCode, building.Centrec_Building, building.Centrec_Building, docType, docType, (clr.clearanceFee * -1).ToString(), "5500/000", "", out pastelString);
        ...
        private void btnNew_Click(object sender, EventArgs e) {
            frmClearances clearances = new frmClearances(0);
        ...
        private void dgUnprocessed_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e) {
            if (e.Button == System.Windows.Forms.MouseButtons.Right) {
                ...
                frmClearances clearances = new frmClearances(clearanceID);
                clearances.ShowDialog();
                ReloadGrids();
            }
        }
