...
namespace Astrodon.Reports.BuildingPMDebtor
{
    public class BuildingPMDebtorResult
    {
        ...
        [ExcelExport(9, "Data Path", true, false, XLCellValues.Text)]
        public string DataPath { get; set; }

        public int PortfolioManagerId { get; set; }

        [ExcelExport(10, "PM", true, false, XLCellValues.Text)]
        public string PortfolioManager { get; set; }

        [ExcelExport(11, "PM Email", true, false, XLCellValues.Text)]
        public string PortfolioManagerEmail { get; set; }

        public int DebtorId { get; set; }

        [ExcelExport(12, "Debtor", true, false, XLCellValues.Text)]
        public string Debtor { get; set; }

        [ExcelExport(13, "Debtor Email", true, false, XLCellValues.Text)]
        public string DebtorEmail { get; set; }

        [ExcelExport(14, "Bank", true, false, XLCellValues.Text)]
        public string Bank { get; set; }

        [ExcelExport(15, "Account Number", true, false, XLCellValues.Text)]
        public string AccountNumber { get; set; }

        [ExcelExport(16, "Branch Code", true, false, XLCellValues.Text)]
        public string BranchCode { get; set; }

        [ExcelExport(17, "Address Line 1", true, false, XLCellValues.Text)]
        public string AddressLine1 { get; set; }

        [ExcelExport(18, "Address Line 2", true, false, XLCellValues.Text)]
        public string AddressLine2 { get; set; }

        [ExcelExport(19, "Address Line 3", true, false, XLCellValues.Text)]
        public string AddressLine3 { get; set; }

        [ExcelExport(20, "Address Line 4", true, false, XLCellValues.Text)]
        public string AddressLine4 { get; set; }

        [ExcelExport(21, "Address Line 5", true, false, XLCellValues.Text)]
